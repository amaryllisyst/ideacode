...
<head>
	...
	<link rel="icon" href="${pageContext.request.contextPath}/back/img/others/favicon.ico" type="image/x-icon" />
	...
	<script type="text/javascript">
        function refresh(obj){
            obj.src="${pageContext.request.contextPath}/validateCode/code?id="+Math.random();
        }
	</script>
</head>
<body>
		...
		<table>
			...
			<tr>
				<td width="190" rowspan="2" align="center" valign="bottom">
					<img src="${pageContext.request.contextPath}/back//img/others/header_logo.gif" />
				</td>
				<th>
					用户名:
				</th>
				<td>
					<input type="text"  name="realname" class="text" value="" maxlength="20"/>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input name="password" class="easyui-passwordbox" value="" maxlength="20" autocomplete="off"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<img id="captchaImage"  onclick="refresh(this)" class="captchaImage" src="${pageContext.request.contextPath}/validateCode/code" title="点击更换验证码"/>
				</td>
			</tr>
			<tr>
				<td>
